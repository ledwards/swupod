...
/**
 * The lobby — the site's homepage as of the promotion from /lobby to / .
 *
 * Lives here rather than in a route file because BOTH `/` and `/lobby` render
 * it: `/` is a client-side switcher that also serves the legal pages, and
 * `/lobby` stays alive so existing links keep working.
 */
...
export default function LobbyHome(): React.JSX.Element {
