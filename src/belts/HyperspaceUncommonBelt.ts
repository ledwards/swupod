// @ts-nocheck
/**
 * HyperspaceUncommonBelt
 *
 * Same as UncommonBelt but uses Hyperspace variant cards.
 * Seam deduplication ensures no duplicates within 4 slots.
 */
...
export class HyperspaceUncommonBelt {
  setCode: SetCode
  hopper: RawCard[]
  fillingPool: RawCard[]
  ...
  _initialize(): void {
    ...
    // Filter to Hyperspace variant uncommons (non-leader, non-base)
