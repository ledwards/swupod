...
- **Pack Wars and Pack Blitz pulls count too.** Both formats had the same gap, so their packs now reach your collection and your statistics, past pools included.

## 09.04.2026

### 🐞 Bug Fixes

- **Ashes of the Empire Showcase Leaders show their art in your Showcase Collection.** Showcase leaders from Ashes of the Empire were tracked and counted, but their cards rendered blank on the Showcases page. They show front and back now, and the collection total and export order include the new set.
