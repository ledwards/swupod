...
- Match page: both players' presence, either-player cancel (uses `variant="danger"` conventions), Companion hero via `PluginCTA variant="autodetect"`, small always-visible troubleshooting note with the honest fallback copy (R25); mobile leads with the finish-on-desktop notice (R24).
