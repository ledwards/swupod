...
- R24. Mobile: posting/accepting works on mobile, but the match page on mobile leads with a "finish this on desktop" / manual-path notice instead of the Companion CTA (the Companion is desktop-only). A mobile poster delisted while backgrounded sees a "your game was delisted — repost?" prompt on return.
